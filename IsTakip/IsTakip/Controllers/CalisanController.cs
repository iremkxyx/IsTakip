    ...
    public class CalisanController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (yetkiTurId==2)
            {
                ...
                var isler=(from i in entity.Isler where i.isPersonelId==personelId
                           && i.isOkunma==false orderby i.iletilenTarih descending
                           select i).ToList();
                ViewBag.isler = isler;
        ...
        {
            var tekIs= (from i in entity.Isler where i.isId==isId 
         ...
         public ActionResult Yap()
        {
            ...
            if (yetkiTurId == 2)
            {
                int personelId = Convert.ToInt32(Session["PersonelId"]);
                var isler=(from i in entity.Isler where i.isPersonelId==personelId
                           && i.isDurumId==1 select  i).ToList().OrderByDescending(İ=>İ.iletilenTarih);
                ViewBag.isler = isler;
